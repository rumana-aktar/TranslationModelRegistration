...
function dirnameOutMotion=getMotionBorder(MM, xy, dirname, iMosaicDirname, Fm, Fn, FrameDir, filesFrame, border, line, motionOnImosaic, sameIMosaicDir, dirnameOutMotion)
