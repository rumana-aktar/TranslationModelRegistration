function [xbeginFrame, ybeginFrame]=getTranslationPrevFrame(NCC, template_row_start, template_hight, template_col_start, template_width, Frame, prevFrame, saved_matched_Points, save_tx_ty, i, dirnameOutFeatureMatched, dirnameOutMotion, SURF_Feature_Mean_Mode)
    ...
    if NCC == 1
        ...
        [mean_x, mean_y, mode_x, mode_y, mean_ix, mean_iy, mode_ix, mode_iy]=getTranslation(rgb2gray(prevFrame), rgb2gray(Frame), saved_matched_Points,save_tx_ty, i, dirnameOutFeatureMatched, dirnameOutMotion);    
